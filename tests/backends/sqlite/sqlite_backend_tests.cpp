...
int main()
{
    ...
    test_sqlite_backend_rebuilds_added_unique_index();
    test_sqlite_backend_rejects_added_unique_index_with_existing_duplicates();
    ...
    test_sqlite_backend_updates_and_deletes_unique_index_entries();
    test_sqlite_backend_unique_indexes_reject_missing_path_but_allow_same_key_update_and_delete();
